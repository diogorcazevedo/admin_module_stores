                                                ...
                                                <div className="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                                    ...
                                                    <div className="sm:col-span-2">
                                                        <InputMask
                                                            required
                                                            type="text"
                                                            id="data_cliente_envio"
                                                            name="data_cliente_envio"
                                                            autoComplete="data_cliente_envio"
                                                            mask="99-99-9999"
                                                ...
                                                <div className="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                                    ...
                                                    <div className="sm:col-span-2">
                                                        <InputMask
                                                            required
                                                            type="text"
                                                            id="data_cliente_chegada"
                                                            name="data_cliente_chegada"
                                                            autoComplete="data_cliente_chegada"
                                                            mask="99-99-9999"
                                                ...
                                                <div className="space-y-1 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                                    ...
                                                    <div className="sm:col-span-2">
                                                        <InputMask
                                                            ...
                                                            type="text"
                                                            id="data_cb_chegada"
                                                            name="data_cb_chegada"
                                                            autoComplete="data_cb_chegada"
                                                            mask="99-99-9999"
