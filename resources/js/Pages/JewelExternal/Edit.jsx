...
export default function Edit( {jewel_external,collections,categories}) {

    const { data, setData, post, processing, errors, delete: destroy ,get} = useForm({
        name: jewel_external.name,
        category_id: jewel_external.category_id,
        collection_id: jewel_external.collection_id,

    })

    function submit(e) {
        e.preventDefault()
        post(route("jewel.external.update",{jewel:jewel_external.id}));

    }
    function destruction() {
        if (confirm("Deseja realmente apagar este registro?")) {
            get(route("jewel.external.destroy",{jewel:jewel_external.id}));
        }
    }
