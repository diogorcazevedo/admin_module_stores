...
import InputMask from "react-input-mask";
  ...
  export default function Edit({message,url}) {

    const {auth} = usePage().props

    const { data, setData, post, processing, errors} = useForm({
        necessidade:    message.necessidade,
        providencia:    message.providencia,
        canal:          message.canal,
        dt_retorno:     message.dt_retorno ? moment(message.dt_retorno).format('DD-MM-YYYY'):moment().add(3, 'days').format('DD-MM-YYYY'),
    ...
    function submit(e) {
      e.preventDefault()
      post(route('support_messages.update',{id:message.atendimento_id}))
    }
