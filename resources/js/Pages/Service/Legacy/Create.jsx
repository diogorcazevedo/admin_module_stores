...
export default function Create({user,centers,sales}) {
    ...
    function submit(e) {
        e.preventDefault()
        post(route('service.legacy.store'));
                   ...
                   <div className="rounded p-6 overflow-hidden shadow-lg">
                       <div className="shadow mt-6 p-4 flex flex-row">
                           <div className="basis-1/3">
                               <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Criar Ajustes em joias Antigas CB - Ordem de Serviço</h2>
                           </div>
                       </div>
