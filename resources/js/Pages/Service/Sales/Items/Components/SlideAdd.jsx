...
import SlideChangeOrder from "@/Pages/Service/Sales/Items/Components/SlideChangeOrder";

export default function SlideAdd({order_items,service}) {
                                                    ...
                                                    <div className="mt-6 grid grid-cols-1 gap-4 justify-end">
                                                        <div className="shadow mt-6 p-4 flex flex-row">
                                                            <div className="basis-2/3">
                                                                <h2 className="text-xl font-bold leading-7 text-gray-900 sm:text-xl sm:truncate">Adicionar Produto de Reparo </h2>
                                                            </div>
                                                        ...
                                                        <table className="mt-6 border min-w-full divide-y divide-x divide-gray-200">
                                                            <thead className="bg-gray-50 divide-y divide-x divide-gray-200">
                                                            <tr className="divide-x divide-y divide-gray-200">
                                                                <th className="text-gray-900 p-2">Imagem</th>
                                                                <th className="text-gray-900 p-2">Nome</th>
                                                            ...
                                                            {order_items.map((item) => (
                                                                <tr key={item.id} className="divide-x divide-y divide-gray-200">
                                                                    ...
                                                                    <td className="text-xs p-2">
                                                                        <Link href={route('service_items.sales.add',{service_id:service.id, product_id:item.product.id})}
