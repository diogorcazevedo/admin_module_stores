...
export default function Create({service_item}) {
    ...
    function submit(e) {
        e.preventDefault()
        post(route('service_items.external.update',{id:service_item.id}));
    }
       ...
       <>
           ...
           <Auth auth={auth} errors={errors}>
                   ...
                   <div className="rounded p-6 overflow-hidden shadow-lg">
                       <div className="shadow mt-6 p-4 flex flex-row">
                           <div className="basis-1/3">
                               <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Editar serviço de reparo de Joia - outras marcas - Ordem de Serviço</h2>
                           </div>
                       </div>
               ...
               <div className="shadow mt-6 p-4 flex flex-row-reverse">
                   <div className="basis-1/3">
                       <Link href={route('service_items.external.show',{id:service_item.service_id})}
