...
export default function Edit({service,centers}) {
    ...
    function submit(e) {
        e.preventDefault()
        post(route('service.external.update',{id:service.id}));
    }
                   ...
                   <div className="rounded p-6 overflow-hidden shadow-lg">
                       <div className="shadow mt-6 p-4 flex flex-row">
                           <div className="basis-1/3">
                               <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Editar Ajustes em joias de outras marcas - Ordem de Serviço</h2>
                           </div>
                       </div>
