...
import SlideProductQuantityYearAndMonth from "@/Pages/Reports/Components/ProductComponents/Quantity/SlideProductQuantityYearAndMonth.jsx";


export default function ModalProductQuantitySelectYearAndMonth({year,month}) {
    ...
    function menuItems(year){
        ...
        for (let i = 1; i < 13; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideProductQuantityYearAndMonth year={year} month={i}/>
                    )}
                </Menu.Item>
            );
        }
