...
export default function ReportProductQuantityYearAndMonthList({center,year,month}) {
    ...
    useEffect(() => {
        ...
        const url =  `https://administracaodosistema.com.br/reports/api/report/product/month_quantity/`+year+'/'+month+"/"+center
        ...
        <>
            ...
            {!loading &&
                <div className="grid grid-cols-1 gap-4">
                    <div>
                        <p className="bg-teal-800 py-2 px-2 text-white">Produtos POR QTD: {month_name} / {year} </p>
                    </div>
                    <div>
