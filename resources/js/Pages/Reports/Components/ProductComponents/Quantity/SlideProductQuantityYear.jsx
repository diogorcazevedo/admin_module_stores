...
import ReportProductQuantityYearList
    from "@/Pages/Reports/Components/ProductComponents/Quantity/ReportProductQuantityYearList.jsx";



export default function SlideProductQuantityYear({year}) {
                                        ...
                                        <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-lg font-medium text-teal-600"> Relatório Produtos POR QTD ano: {year} </Dialog.Title>
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
                                                    <div className="mt-6 grid grid-cols-1 gap-4 justify-end">
                                                        <ReportProductQuantityYearList center={auth.user.centro_id} year={year}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
