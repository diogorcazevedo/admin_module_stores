...
import SlideProductSalesYearAndMonth
    from "@/Pages/Reports/Components/ProductComponents/Sales/SlideProductSalesYearAndMonth.jsx";


export default function ModalProductSalesSelectYearAndMonth({year,month}) {
    ...
    function menuItems(year){
        ...
        for (let i = 1; i < 13; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideProductSalesYearAndMonth year={year} month={i}/>
                    )}
                </Menu.Item>
            );
        }
