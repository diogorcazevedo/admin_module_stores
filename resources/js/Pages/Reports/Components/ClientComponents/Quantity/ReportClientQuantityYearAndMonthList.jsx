...
export default function ReportClientQuantityYearAndMonthList({center,year,month}) {
    ...
    useEffect(() => {
        ...
        const url =  `https://administracaodosistema.com.br/reports/api/report/client/month_quantity/`+year+'/'+month+"/"+center
