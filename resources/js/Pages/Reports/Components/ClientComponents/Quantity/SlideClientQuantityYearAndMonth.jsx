...
import ReportClientSalesYearList
    from "@/Pages/Reports/Components/ClientComponents/Sales/ReportClientSalesYearList.jsx";
import ReportClientSalesYearAndMonthList
    from "@/Pages/Reports/Components/ClientComponents/Sales/ReportClientSalesYearAndMonthList.jsx";
import ReportClientQuantityYearAndMonthList
    from "@/Pages/Reports/Components/ClientComponents/Quantity/ReportClientQuantityYearAndMonthList.jsx";


export default function SlideClientQuantityYearAndMonth({year,month}) {
                                        ...
                                        <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-lg font-medium text-teal-600">Relatório SALES POR QTD:  {month_name} - {year} </Dialog.Title>
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
                                                    <div className="mt-6 grid grid-cols-1 gap-4 justify-end">
                                                        <ReportClientQuantityYearAndMonthList center={auth.user.centro_id} year={year} month={month} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
