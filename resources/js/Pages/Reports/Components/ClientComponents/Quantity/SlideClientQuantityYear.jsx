...
import ReportClientQuantityYearList
    from "@/Pages/Reports/Components/ClientComponents/Quantity/ReportClientQuantityYearList.jsx";



export default function SlideClientQuantityYear({year}) {
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
                                                    <div className="mt-6 grid grid-cols-1 gap-4 justify-end">
                                                        <ReportClientQuantityYearList center={auth.user.centro_id} year={year}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
