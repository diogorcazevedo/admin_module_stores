...
import SlideClientQuantityYearAndMonth from "@/Pages/Reports/Components/ClientComponents/Quantity/SlideClientQuantityYearAndMonth.jsx";


export default function ModalClientQuantitySelectYearAndMonth({year,month}) {
    ...
    function menuItems(year){
        ...
        for (let i = 1; i < 13; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideClientQuantityYearAndMonth year={year} month={i}/>
                    )}
                </Menu.Item>
            );
        }
