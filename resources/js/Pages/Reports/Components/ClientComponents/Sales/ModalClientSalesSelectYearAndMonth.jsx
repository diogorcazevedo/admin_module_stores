...
import SlideClientSalesYearAndMonth
    from "@/Pages/Reports/Components/ClientComponents/Sales/SlideClientSalesYearAndMonth.jsx";


export default function ModalClientSalesSelectYearAndMonth({year,month}) {
    ...
    function menuItems(year){
        ...
        for (let i = 1; i < 13; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideClientSalesYearAndMonth year={year} month={i}/>
                    )}
                </Menu.Item>
            );
        }
