...
export default function ReportClientSalesYearList({center,year}) {
    ...
    useEffect(() => {
        ...
        const url =  `https://administracaodosistema.com.br/reports/api/report/client/year_sales/`+year+"/"+center
        const getData = async () => {
            try {
        ...
        <>
            ...
            {!loading &&
                <div className="grid grid-cols-1 gap-4">
                    <div>
                        <p className="bg-teal-800 py-2 px-2 text-white">VENDAS: {year} </p>
                    </div>
                    <div>
