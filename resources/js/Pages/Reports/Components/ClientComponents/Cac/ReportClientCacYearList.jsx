...
export default function ReportClientCacYearList({center,year}) {
    ...
    useEffect(() => {
        ...
        const url =  `https://administracaodosistema.com.br/reports/api/report/client/year_cac/`+year+"/"+center
        const getData = async () => {
            try {
                    ...
                    <div className="px-4 py-6 sm:px-6 lg:pl-8 xl:flex-1 xl:pl-6">
                        <div className="flex flex-row">
                            <div className="basis-1/2">
                                <p className="bg-teal-800 py-2 px-2 text-white">Clientes Novos</p>
                                {clientsTable(dataNew,newTotal)}
                            </div>
                            <div className="ml-4 basis-1/2">
                                <p className="bg-teal-800 py-2 px-2 text-white">Clientes Antigos</p>
                                {clientsTable(dataOld,oldTotal)}
                            </div>
                        </div>
