...
export default function SlideClientCacYearAndMonth({year,month}) {
                                        ...
                                        <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-lg font-medium text-teal-600">Relatório CAC:  {month_name} - {year}</Dialog.Title>
