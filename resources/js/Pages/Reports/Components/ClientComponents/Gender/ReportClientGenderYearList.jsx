...
export default function ReportClientGenderYearList({gender, center,year}) {
    ...
    useEffect(() => {
        ...
        const url =  `https://administracaodosistema.com.br/reports/api/report/client/year_gender/`+gender+"/"+year+"/"+center
        const getData = async () => {
            try {
