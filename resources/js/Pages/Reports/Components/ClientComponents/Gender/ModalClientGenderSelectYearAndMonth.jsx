...
import SlideClientGenderYearAndMonth from "@/Pages/Reports/Components/ClientComponents/Gender/SlideClientGenderYearAndMonth.jsx";


export default function ModalClientGenderSelectYearAndMonth({gender, year,month}) {
    ...
    function menuItems(year){
        ...
        for (let i = 1; i < 13; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideClientGenderYearAndMonth gender={gender} year={year} month={i}/>
                    )}
                </Menu.Item>
            );
        }
