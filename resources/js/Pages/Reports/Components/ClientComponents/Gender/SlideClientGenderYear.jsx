...
import ReportClientGenderYearList from "@/Pages/Reports/Components/ClientComponents/Gender/ReportClientGenderYearList.jsx";



export default function SlideClientGenderYear({gender, year}) {
        ...
        <>
            <div className="flex flex-row p-2">
                <button onClick={() => setOpen(true)} className="group inline-flex w-full text-base font-medium border border-transparent items-center px-2.5 py-1.5 text-xs font-medium rounded text-white bg-teal-800 hover:bg-teal-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
                    ...
                    <span className="text-white group-hover:text-gray-700 text-xs">{year}</span>
                </button>
            </div>
                                        ...
                                        <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-lg font-medium text-teal-600"> Relatório SALES POR QTD ano: {year} </Dialog.Title>
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
                                                    <div className="mt-6 grid grid-cols-1 gap-4 justify-end">
                                                        <ReportClientGenderYearList gender={gender} center={auth.user.centro_id} year={year}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
