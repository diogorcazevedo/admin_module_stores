...
import ModalProductQuantitySelectYearAndMonth from "@/Pages/Reports/Components/ProductComponents/Quantity/ModalProductQuantitySelectYearAndMonth.jsx";
import SlideProductQuantityYear from "@/Pages/Reports/Components/ProductComponents/Quantity/SlideProductQuantityYear.jsx";
import SlideProductSalesYear from "@/Pages/Reports/Components/ProductComponents/Sales/SlideProductSalesYear.jsx";
import ModalProductSalesSelectYearAndMonth from "@/Pages/Reports/Components/ProductComponents/Sales/ModalProductSalesSelectYearAndMonth.jsx";
    ...
    function menuQuantityItems(){
        ...
        for (let i = 2017; i < 2025; i++) {
            menuItems.push(
                <Menu.Item key={i}>
                    {({ active }) => (
                        <SlideProductQuantityYear year={i}/>
                    )}
                </Menu.Item>
            );
        }
                                    ...
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                ...
                                                <dt className="text-gray-500"><ModalProductSalesSelectYearAndMonth year={year} month={month}/></dt>
                                            </div>
                                        </dl>
                                    </li>
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                ...
                                                <dt className="text-gray-500"><ModalProductQuantitySelectYearAndMonth year={year} month={month}/></dt>
                                            </div>
                                        </dl>
                                    </li>
