               ...
               <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                   <div className="shadow mt-6 p-4 flex flex-row">
                       <div className="basis-2/3">
                           <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Manufacturers</h2>
                       </div>
                   ...
                   <div className=" rounded p-6 px-6 overflow-hidden shadow-xl">
                       ...
                       {manufacturers.map((manufacturer) => (
                           <tr key={manufacturer.id} className="divide-x divide-y divide-gray-200">
                               <td className="text-sm p-2">
                                   <Link href={route('manufacturer.edit',{id:manufacturer.id})}>
                                       {manufacturer.id}
                                   </Link>
                               </td>
                               <td className="text-sm p-2">
