        ...
        <Auth auth={auth} errors={errors} >
          <Head title="Manufacturer" />
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-16">
                <div className="p-6 rounded overflow-hidden shadow-lg">
                    <div className="shadow mt-6 p-4 flex flex-row">
                        <div className="basis-1/3">
                            <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Cadastrar Fabricante</h2>
                        </div>
                    </div>
