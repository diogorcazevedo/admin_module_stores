...
import ShippingReverse from "@/Pages/Shipping/Components/ShippingReverse";
import {Link} from '@inertiajs/react'



export default function CardShippingClose({order,items,user,shippings}) {
            ...
            <div className="mb-4 p-6 bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:p-0">
                    <dl className="sm:divide-y sm:divide-gray-200">
                        ...
                        <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-sm font-medium text-gray-500 sm:col-span-2">Reverso</dt>
                            <dd className="mt-1 text-sm text-gray-900 sm:mt-0">
                                <ShippingReverse order={order} user={user} items={items}/>
                            </dd>
                        </div>
                    </dl>
                </div>
