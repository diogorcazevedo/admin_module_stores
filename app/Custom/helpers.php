...
function replace_hyphen_for_dot($valor){
    $valor = trim($valor);
...
function data_reverse_barra_para_traco($dt)
{
    return implode("/",explode("/",$dt));
}

function data_reverse_traco_para_barra($dt)
{
    return implode("-",(explode("/",$dt)));
}
